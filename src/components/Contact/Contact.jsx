...
const Contacto = () => {
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_di6xjep', 'template_rzmruld', e.target, 'ZAPktphb4_mUEdgNy')
    .then((response) => {
      ...
      <div className={Styles.contenedor}>
        ...
        <div className={Styles.contenedor2}>
          ...
          <form onSubmit={sendEmail}>
            <label>
              Nombre:
              <input type="text" name="from_name" required style={{ padding: '5px', margin: '5px 0' }} />
            </label>
            <br />
            <label>
              Correo electrónico:
              <input type="email" name="to_email" required style={{ padding: '5px', margin: '5px 0' }} />
            </label>
            <br />
            <label>
              Mensaje:
              <textarea name="message_html" required style={{ padding: '10px', margin: '5px 0' }} />
            </label>
            <br />
