      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => setFormData((prev) => ({
            ...prev, tipo: { ...prev.tipo, nombre: e.target.value }
          }))}
        />
      </div>
      <div>
        ...
        {formData.caracteristicas.map((caracteristica, index) => (
          <div key={index}>
            ...
            />
            <button type="button" onClick={() => handleRemoveCaracteristica(index)}>Eliminar</button>
          </div>
        ))}
        <input
          type="text"
        ...
        />
        <button type="button" onClick={handleAddCaracteristica}>Añadir</button>
      </div>
